...
# Define the exact path to the MRI pancreas DICOM directory.
# This assumes the 'dash-vtk' repository has been cloned and is located at /content/dash-vtk.
volume_data_dir = "dash-vtk/demos/data/mri_pancreas" # Updated path to MRI pancreas data

# Check if the directory exists before attempting to load
if not os.path.exists(volume_data_dir):
    print(f"Error: Volume data directory not found at {volume_data_dir}")
    print("Please ensure you have cloned the 'dash-vtk' repository and the 'mri_pancreas' data is present.")
